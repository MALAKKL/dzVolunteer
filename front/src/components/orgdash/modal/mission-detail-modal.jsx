...
export default function MissionDetailModal({ mission, onClose, onShowVolunteers, isArchived = false }) {
        ...
        <div style={{ padding: "1.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "1.5rem", marginBottom: "1.5rem", flexWrap: "wrap" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "#6b7280" }}>
              <FiCalendar size={16} />
              <span>{mission.startDate || mission.date}</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "#6b7280" }}>
              <FiMapPin size={16} />
          ...
          <p style={{ color: "#0F393B", fontSize: "1.125rem", marginBottom: "1.5rem" }}>
            {mission.description}
          </p>
          ...
          <div style={{ display: "flex", gap: "1rem" }}>
            ...
            {onShowVolunteers && (
              <button
                onClick={() => onShowVolunteers(mission.id)}
                style={{
                  flex: 1,
                  padding: "0.75rem",
                  borderRadius: "6px",
              ...
              >
                Show Volunteers in This Mission
              </button>
            )}
          </div>
        </div>
