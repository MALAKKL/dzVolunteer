...
export default function Home() {
  ...
  // NEW: Fetch missions from backend
  useEffect(() => {
    const fetchMissions = async () => {
      try {
        ...
        // REPLACE THIS URL WITH YOUR ACTUAL BACKEND API ENDPOINT
            // Change this line in your home page (line 49)
const response = await fetch('http://localhost:5000/api/missions')
        ...
        // If your API returns missions in a nested structure, adjust accordingly
        // For example: data.missions or data.data
        setMissions(data)
        setMissionsError(null)
      } catch (error) {
        console.error('Error fetching missions:', error)
        setMissionsError(error.message)
        // Keep the hardcoded missions as fallback
        setMissions([
          {
            id: 1,
            title: "Medical",
  ...
  // NEW: Handle mission click
  const handleMissionClick = (missionId) => {
    // You can navigate to a detailed mission page
    // Using Next.js router: router.push(`/missions/${missionId}`)
    console.log('Mission clicked:', missionId)
    // TODO: Implement navigation to mission details page
  }
        ...
        <section id="home" ref={(el) => (sectionRefs.current["home"] = el)} className="section home-section">
          <div className="home-content">
            ...
            <div className="social-icons">
              ...
              <a
  href="mailto:dzvolunteer970@gmail.com"
...
>
  <MdEmail size={20} />
        ...
        {/* missions section - NOW WITH DYNAMIC DATA */}
        <section
          id="missions"
